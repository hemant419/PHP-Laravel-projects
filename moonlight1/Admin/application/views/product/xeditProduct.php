	 ...
	 <select id="prdtype" tabindex="3" class="chosen-select form-control" style="width: 240px;" name="prdtype">  
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <label>Size</label>
	    <input type="number" id="few-ml"  min="5" name="size" value="<?php echo $product->prd_size?>" class="form-control" required>
                </div>
              </div>
             <div class="col-md-2">
                <div class="form-group">
			...
			<div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea id="position-ml" name="prdDesc"  class="form-control" required>
				  <?php echo $product->prd_description?></textarea>
				</div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Product Feature</label>
                  <textarea id="position-ml" name="prdFeature" class="form-control" required>
				  <?php echo $product->prd_feature?></textarea>
                </div>
              </div>
            </div>
			<div class="row">
