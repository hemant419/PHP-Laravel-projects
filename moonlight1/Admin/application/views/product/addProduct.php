...
//					$("#sizeF").attr('required',true);
					...
					$("#subdata").html(multi[0]);
					//alert(multi[2]);
					$("#prdtype").html(multi[2]);
				}
			});
}
				...
				<div class="col-md-4">
                  <div class="form-group">
					...
					<?php foreach($offers as $offersData){?>
						<option value="<?php echo $offersData->offer_id?>"><?php echo $offersData->offer_title?> </option>
					<?php }?>
                    </select>
					</div>
				</div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <textarea id="position-ml" name="prdDesc" rows="10" cols="20" maxlength="" minlength="" class="form-control" required></textarea>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Product Higligths</label>
                    <textarea id="position-ml" name="prdFeature"  rows="10" cols="20" maxlength="" minlength="" class="form-control" required></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
