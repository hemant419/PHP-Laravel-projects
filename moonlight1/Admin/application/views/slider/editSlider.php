      ...
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">
			<div class="row">
	         <div class="col-md-7">		
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/sliderControl/updateSlider/<?php echo $slider->slider_id?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">Title</label>
                <div class="col-sm-8">
                  <input type="text" name="title" value="<?php echo $slider->slider_title ?>" class="form-control" id="input01" required>
                </div>
              </div>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-sm-8 col-sm-offset-2">
                  <input name="submit" type="submit" class="btn btn-raised btn-danger" id="submit" value="Update">                 </div>
              </div>
            </form>
			</div>
				 <div class="col-md-5">
			<img src="<?php echo base_url() ?>slider/<?php echo $slider->slider_img ?>" width="190" height="100"/>	
				 </div>
			</div>
          </div>
        </section>
