      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header">
            <h3 class="custom-font hb-blush"> <strong>Add New</strong> Brand</h3>
          </div>
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/Brandcontrol/insertBrand" method="post" enctype="multipart/form-data">
             <div class="form-group">
                     <label for="input01" class="col-sm-2 control-label">Category</label>
                   <div class="col-sm-4">
			 <select tabindex="3" id="default-ml" class="chosen-select form-control" style="width: 240px;" name="catId" id="catId" onchange="Subcat(this.value)" required>
			 ...
			 <div class="form-group">
                ...
                <div class="col-sm-4">
				<p style="color:red"></p>
			   <select tabindex="3" class="chosen-select form-control" style="width: 240px;" name="subcatId" id="subdata"  required>
							  
				</select>
	             </div>
              </div>
			 <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">Brand Name</label>
                <div class="col-sm-4">
				<p style="color:red"></p>
    <input type="text" name="Bname" placeholder="Enter Brand Name" class="form-control" id="input01" required>
                </div>
              </div>
