      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header">
            <h3 class="custom-font hb-blush"> <strong>Add New</strong> Discount</h3>
          </div>
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/discountcontrol/insertDiscount" method="post" enctype="multipart/form-data">
             <div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-4">
				<p style="color:red"></p>
            <input type="number" name="discount" placeholder="Discount" class="form-control" id="input01" min="0" required>
                </div>
              </div>
              <div class="form-group">
