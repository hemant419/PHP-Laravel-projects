    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/Statecontrol/updatestate/<?php echo $state->state_id?>" method="post" >
              
			  <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">State Name</label>
                <div class="col-sm-4">
				<p style="color:red"></p>
                  <input type="text" name="Statename" value="<?php echo $state->state_name ?>" class="form-control" id="input01" required>
                </div>
              </div>
