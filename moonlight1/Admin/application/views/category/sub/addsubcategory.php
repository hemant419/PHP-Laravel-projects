    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">
            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url()?>/subcategorycontrol/insertSubcategory">
              ...
              <div class="form-group">
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Sub-Category Name</label>
			  	     <div class="col-sm-4">
     <input type="text" name="subcatName" class="form-control" id="inputEmail3" placeholder="Sub-Category Name"required>
                      </div>  
			  </div>
			  <div class="form-group">
