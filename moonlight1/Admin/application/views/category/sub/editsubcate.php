      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header">
            <h3 class="custom-font hb-blush"> <strong>Edit </strong>Sub Category</h3>
          </div>
          <div class="boxs-body">
            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url()?>/subcategorycontrol/updateSubcategory">
              <div class="form-group">
                 <label class="col-sm-2 control-label">Main Category</label>
                     <div class="col-sm-10">
                        <input type="hidden" name="subcatId" value="<?php echo $subcategory->subcat_id ?>"/>  
						  <select tabindex="3" class="chosen-select" name="catId" style="width: 240px;" required>
                         	<?php 
								foreach($maincategory as $maincat){		?>
							   
							    <option value="<?php echo  $maincat->cat_id ?>" 
								<?php 
							echo ($maincat->cat_id==$subcategory->cat_id) ? "selected='selected'":null ;?> >
              ...
              <div class="form-group">
              	<label for="inputEmail3" class="col-sm-2 control-label">Sub-Category Name</label>
			  	     <div class="col-sm-4">
     			<input type="text" name="subcatName" class="form-control" id="inputEmail3" 
