      ...
      <div class="col-md-12">
        <section class="boxs ">
          <div class="boxs-header">
            <h3 class="custom-font hb-cyan"> <strong>Order</strong> Master</h3>
          </div>
          <div class="boxs-body">
            ...
            <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
              ...
              <tbody>
                ...
                <tr>
				  ...
				  $this->db->where('storestatus','Active');
				  $cnt=$this->db->get('store_cart')->result();
				  if(count($cnt)>0)
				  {
				   ?>
                 ...
                 <!-- <td width="5"><?php //echo $data->user_name ?></td>-->
                  <td width="10"><?php echo $data->user_name ." ".$data->user_lastname ?></td>
