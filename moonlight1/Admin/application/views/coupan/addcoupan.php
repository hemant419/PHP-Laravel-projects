    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/coupancontrol/insertcoupan" method="post" >
             <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">Coupan Code</label>
                <div class="col-sm-4">
				<p style="color:red"></p>
                  <input type="text" name="coupancode" placeholder="Enter Coupan code" class="form-control" id="input01" required>
                </div>
              </div>
			  <div class="form-group">
                ...
                <div class="col-sm-6">
				<p style="color:red"></p>
                  <input type="email" name="coupanmail" placeholder="Enter Email" class="form-control" id="input01" required>
                </div>
              </div>
			  <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">Coupan Uses</label>
                <div class="col-sm-2">
				<p style="color:red"></p>
              <input type="text" name="coupanuse" placeholder="Enter Uses" class="form-control" id="input01" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                  <a href="<?php echo site_url()?>/coupancontrol/" class="btn btn-raised btn-danger" >Cancel</a>&nbsp;            <input name="submit" type="submit" class="btn btn-raised btn-default" value="Save"></div>
              </div>
            </form>
          </div>
        </section>
