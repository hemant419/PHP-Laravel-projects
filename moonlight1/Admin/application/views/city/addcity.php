    ...
    <div class="row">
      <div class="col-md-12">
        <section class="boxs">
          ...
          <div class="boxs-body">
            <form class="form-horizontal" role="form" name="add" action="<?php echo site_url()?>/citycontrol/insertcity" method="post"  >
             <div class="form-group">
               <label class="col-sm-2 control-label">State Name:- </label>
                     <div class="col-sm-10">
                          <select tabindex="3" class="chosen-select" id="StaId" name="StaId" style="width: 240px;"required >
                            	<option value="" >
										-- Select State Id --
								</option>
                ...
                <div class="col-sm-4">
				<p style="color:red"></p>
     <input type="text" name="cityname" placeholder="Enter City Name" class="form-control" id="input01" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                  ...
                  <input name="submit" type="submit" class="btn btn-raised btn-default" value="Save" onclick="sub(this.value)">
				  </div>
              </div>
            </form>
          </div>
