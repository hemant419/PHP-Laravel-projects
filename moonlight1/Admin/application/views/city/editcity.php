      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header">
            <h3 class="custom-font hb-blush"> <strong>Add New</strong> city</h3>
          </div>
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/citycontrol/updatecity/<?php echo $city->city_id?>" method="post" >
              	<div class="form-group">
               <label class="col-sm-2 control-label">State Name:- </label>
                     <div class="col-sm-10">
                          <select tabindex="3" class="chosen-select" name="StaId" style="width: 240px;">
                            	<!--<option value="" required>
										-- Select State Id --
								</option>-->
							<?php foreach($state as $data){ ?>
								
							    <option value="<?php echo $data->state_id;  ?>" <?php echo ($data->state_id==$city->state_id)?"selected='selected'":null ?> >
			  ...
			  <div class="form-group">
                <label for="input01" class="col-sm-2 control-label">City Name</label>
                <div class="col-sm-4">
				<p style="color:red"></p>
                  <input type="text" name="cityname" value="<?php echo $city->city_name ?>" class="form-control" id="input01" required>
                </div>
              </div>
