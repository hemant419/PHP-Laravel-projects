      ...
      <div class="col-md-12">
        <section class="boxs ">
          <div class="boxs-header">
            <h3 class="custom-font hb-cyan"> <strong>New  &nbsp;</strong>FAQ </h3>
          </div>
		...
		<img src="<?php echo base_url() ?>product/<?php echo $data->prd_img1; ?>" width="90" height="100"/>
					...
					<td>
				<a href="<?php echo site_url()?>/faqcontrol/letestfaqstatus/<?php echo $data->faq_id?>" style="text-decoration:none"><p class="<?php if( $data->faq_status=="Active"){ ?>btn btn-raised btn-success btn-sm	<?php	}else{	?>btn btn-raised btn-danger btn-sm<?php }?>"> <?php echo $data->faq_status?></p>	</a>
					</td>
					<td> 
