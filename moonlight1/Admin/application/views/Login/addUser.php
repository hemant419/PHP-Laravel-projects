    ...
    <div class="bg-light lter b-b wrapper-md mb-10">
      <div class="row">
        <div class="col-sm-6 col-xs-12">
          <h1 class="h3 m-0">Add New User</h1>
         </div>
      </div>
    </div>
    <!-- row -->
...
<form  name="form1" role="form" id="form1" method="post" data-parsley-validate action="<?php echo site_url() ?>/welcome/addUserByAdmin">
            <div class="row"> 
			...
			<div class="row">
                <div class="form-group col-md-4">
                 <label for="city" >Status : </label>
                  <select name="status" id="city" class="form-control" required>
