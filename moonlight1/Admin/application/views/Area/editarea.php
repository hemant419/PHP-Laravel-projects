...
{
		 $.ajax({
				url:"<?php echo site_url()?>/areacontrol/selectCityEdit/<?php echo $area->state_id ?>/<?php echo $this->uri->segment(3); ?>",
					success:function(dataArea)
					{
						$("#cityId").html(dataArea);
...
function state(id)
{
	$.ajax({
					...
					url:"<?php echo site_url()?>/areacontrol/stateArea/"+id,
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header">
            <h3 class="custom-font hb-blush"> <strong>Edit</strong> Area</h3>
          </div>
          <div class="boxs-body">
            <form class="form-horizontal" role="form" action="<?php echo site_url()?>/areacontrol/updatearea/<?php echo $area->area_id?>" method="post" >
                     ...
                     <div class="col-sm-10">
                          <select tabindex="3" class="chosen-select" name="StaId" style="width: 240px;" onchange="state(this.value)" required>
							...
							<?php foreach($state as $data){ ?>
							    ...
							    <option value="<?php echo $data->state_id;  ?>"  <?php echo ($data->state_id==$area->state_id)?"selected='selected'":null ?>>
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-4">
				<p style="color:red"></p>
                  <input type="text" name="areaname" value="<?php echo $area->area_name ?>" class="form-control" id="input01" required>
                </div>
              </div>
			  <div class="form-group">
                ...
                <div class="col-sm-4">
				<p style="color:red"></p>
                  <input type="text" name="areapin" value="<?php echo $area->area_pincode ?>" class="form-control" id="input01" required>
                </div>
              </div>
             <hr class="line-dashed full-witdh-line" />
              <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                  ...
                  <input name="submit" type="submit" class="btn btn-raised btn-default" value="Update"> </div>
              </div>
            </form>
          </div>
        </section>
