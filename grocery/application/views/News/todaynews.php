          ...
          <a href="<?php echo site_url();?>/Categoryc">UnCheckAll</a>
              ...
              <a href="<?php echo site_url();?>/Categoryc/CheckAll">CheckAll</a>                           <?php
									...
									<tbody>
                                        ...
                                        <td><input type="checkbox" name="chk[]" value="<?php echo $row->cid?>" checked="checked" /></td>
                                        ...
                                        <?php
											 ...
											 {
												 ?>
                                                 <td><input type="checkbox" name="chk[]" value="<?php echo $row->cid?>"  /></td>
                                        <?php
											 }
											 ?>
											...
											<td>
							<a href="<?php echo site_url();?>/Categoryc/status/<?php echo $row->cid;?>"><?php echo $row->catgstatus ?></a>
                            </td>
            								<td><a href="<?php echo site_url();?>/Categoryc/del/<?php echo $row->cid;?>"><img src="<?php echo base_url();?>assets/images/close-png-7.png" height="30" width="30" /></a>						
     
            								<td>
                                            
                                            <span style="border-left-style:dotted"></span>
     
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                       <a href="<?php echo site_url();?>/Categoryc/edit/<?php echo $row->cid;?>">Edit</td>								
