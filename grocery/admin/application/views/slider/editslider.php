...
<div class="col-md-12">
  <section class="boxs">
    ...
    <div class="boxs-body">
      <form class="form-horizontal" role="form" method="post" name="slider" id="query"  enctype="multipart/form-data">
  
		<input type="hidden" name="id" value="<?php echo $editdata->slider_id; ?>"  />
		
		<div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Slider image</label>
          <div class="col-sm-4">
		  	<input type="file" name="img" value="<?php echo $editdata->slider_image; ?>" class="filestyle" data-buttonText="find file" >
          </div>
        </div>
		<div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Slider Title</label>
          <div class="col-sm-3">
            <input type="text" name="title" value="<?php echo $editdata->slider_title; ?>" class="form-control" id="slide">
          </div>
        </div>
...
<script>
	function askQuery()
	{
		...
		{
			document.getElementById('query').action = "<?php echo site_url()?>/sliderControl/updateslider";
