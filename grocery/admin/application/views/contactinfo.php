            ...
            <div class="pagecontent">
              <div id="rootwizard" class="tab-container tab-wizard">
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li> <a href="#tab2" data-toggle="tab">Account info <span class="badge badge-default pull-right wizard-step">2</span> </a> </li>
                  <li> <a href="#tab1" data-toggle="tab">Contact info <span class="badge badge-default pull-right wizard-step">3</span> </a> </li>
                </ul>
                <div class="tab-content">
                  <div class="tab-pane" id="tab3">
                    <form name="step3" role="form" method="post" action="<?php echo site_url() ?>/Welcome/insertdata">
                      <div class="row">
                        <div class="form-group col-md-4 mb-0">
                          <label for="dnumber">Mobile No. : </label>
                          <input type="number" name="mobile" id="Mobile" class="form-control" placeholder="Enter Mobile No." value="<?php echo $profile->mobile ?>" required>
                        </div>
                      </div>
                       <ul class="pager wizard">
                        <li class="previous">
