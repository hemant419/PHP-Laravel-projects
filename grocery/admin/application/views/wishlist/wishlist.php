				...
				<div class="b-b mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Wishlist Table</h1>
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									<thead>
										<tr>
											...
											<th data-hide="phone">Wishlist Id</th>
											<th data-hide="phone">Product Name</th>
											<th data-hide='phone, tablet'>User Name</th>
											<th data-hide='phone, tablet'>product price</th>
									...
									<td><?php echo $row->w_date ?></td>
								  	<td><a href="<?php echo site_url() ?>/wishlistCon/statas/<?php echo $row->w_id ?>">
                                     <button class="<?php if($row->w_statas=="Active"){ ?>btn btn-raised btn-warning btn-xs<?php }else {?>btn btn-raised btn-danger btn-xs<?php } ?>"><?php echo $row->w_statas; ?></button></a></a></td>

                                    <td><a href="<?php echo site_url() ?>/wishlistCon/deleteda/<?php echo $row->w_id ?>" ><i class="fa fa-trash-o"></i> </a>
