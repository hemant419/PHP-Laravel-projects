          ...
          <div class="boxs-body">
            <div class="form-group">
              ...
              <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                ...
                <tbody>
                  <?php 
						foreach($contactdata as $dataget){
					?>
                  <tr>
                    <th><?php echo $dataget->id; ?></th>
                    <th><?php echo $dataget->contact_name; ?></th>
                    <th><?php echo $dataget->contact_email; ?></th>
                    <th><?php echo $dataget->contact_message; ?></th>
                    <th><?php echo $dataget->contect_no; ?></th>
                    <th><a href="<?php echo site_url() ?>/contactControl/statas/<?php echo $dataget->id; ?>">
                    ...
                    <th><a href="<?php echo site_url()?>/contactControl/deletecontact/<?php echo $dataget->id; ?>"> 						<i class="glyphicon glyphicon-trash"></i></a>
					 <a href="<?php echo site_url() ?>/contactControl/editcontact/<?php echo $dataget->id; ?>">
