    ...
    <div class="boxs-body">
      <form class="form-horizontal" role="form" method="post" name="category" id="query" >
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="name" id="cname" class="form-control" id="inputEmail3" placeholder="Add new Categery">
          </div>
        </div>
...
<script>
	function askQuery()
	{
		...
		{
			document.getElementById('query').action = "<?php echo site_url()?>/categoryControl/insertdata";
