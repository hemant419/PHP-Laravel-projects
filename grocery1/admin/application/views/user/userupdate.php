							...
							<div class="boxs-body">
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									?>
										...
										<tr>
											<th><?php echo $dataget->c_id; ?></th>
											<th><?php echo $dataget->c_name; ?></th>
											<th><?php echo $dataget->c_lastname; ?></th>
											<th><?php echo $dataget->c_email; ?></th>
											<th><?php echo $dataget->c_gender; ?></th>
											<th><?php echo $dataget->c_address; ?></th>
											<th><?php echo $dataget->c_contect; ?></th>
											<th><a href="<?php echo site_url() ?>/userControl/statas/
											<?php echo $dataget->c_id; ?>">
								<?php echo $dataget->statas; ?>
							</a></th>
											<th><?php echo $dataget->date; ?></th>
											<th><a href="<?php echo site_url() ?>/userControl/deleteuser/<?php echo $dataget->c_id; ?>">
											<i class="glyphicon glyphicon-trash"></i></a>
											<a href="<?php echo site_url() ?>/userControl/edituser/<?php echo $dataget->c_id; ?>">
