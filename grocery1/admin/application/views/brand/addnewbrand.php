...
<div class="col-md-12">
  ...
  <div class="col-sm-10">
		...
		<div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="brandname" value="" id="bname" class="form-control" id="inputEmail3" placeholder="Enter brand name..">
          </div>
        </div>
		...
		<div class="form-group">
          ...
          <div class="col-sm-4">
		  	<input type="file" name="img" class="filestyle" data-buttonText="find file" required="required">
          </div>
        </div>
...
<script>
	function askQuery()
	{
		...
		{
			document.getElementById('query').action = "<?php echo site_url()?>/brandControl/insertdata";
