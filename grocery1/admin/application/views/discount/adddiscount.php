...
<div class="col-md-12">
  <section class="boxs">
    ...
    <div class="boxs-body">
      <form class="form-horizontal" role="form"  method="post"name="disc" id="query" >
	  	
		<div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Product Name</label>
   
		     <div class="col-sm-10">
		  	<select tabindex="3" class="chosen-select" style="width: 240px;" name="product">
             <?php foreach($getdata as $data) {?>
				 <option value="<?php echo $data->product_id ?>"
				 <?php // echo ($data->product_id==$discountdata->product_id)?"selected='selected'":null ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="discount" id="dis" class="form-control" id="inputEmail3" placeholder="Add new Discount">
          </div>
        </div>
...
<script>
	function askQuery()
	{
		...
		{
			document.getElementById('query').action = "<?php echo site_url()?>/discountCon/insertdata";
