...
<div class="col-md-12">
  <section class="boxs">
    ...
    <div class="boxs-body">
      <form class="form-horizontal" role="form" method="post" name="category" id="query" action="<?PHP echo site_url() ?>/subcatControl/insertdata">
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Categery Name</label>
		  
          <div class="col-sm-10">
		  <select tabindex="3" class="chosen-select" id="category" style="width: 240px;" name="categery">
		...
		<div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Sub_Categery Name</label>
		  
          <div class="col-sm-3">
            <input type="text" name="subcategery" id="sname" value="" class="form-control" id="inputEmail3" placeholder="Add new Categery">
          </div>
        </div>
...
<script>
	function askQuery()
	{
		...
		if(name=="")
		{
			...
			document.category.sname.focus();
			return false;
		}	
		else 
		{
			document.getElementById('query').action = "<?php echo site_url()?>/subcatControl/insertdata";
