...
<div class="col-md-12">
  <section class="boxs">
    <div class="boxs-header">
      <h3 class="custom-font hb-green"> <strong> City </strong>Form</h3>
    </div>
    <div class="boxs-body">
      <form class="form-horizontal" role="form" method="post" action="<?PHP echo site_url() ?>/cityControl/updatecity">
	  	
		<input type="hidden" name="sid" value="<?php  echo $editcity->city_id ?>" >
		<div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">State Name</label>
   
		     <div class="col-sm-10">
		  	<select tabindex="3" class="chosen-select" style="width: 240px;" name="state">
             <?php foreach($statedata as $data) {?>
				 <option value="<?php echo $data->state_id ?>"
				 <?php echo ($data->state_id==$editcity->state_id)?"selected='selected'":null ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="city" value="<?php  echo $editcity->city_name ?>" class="form-control" id="inputEmail3" placeholder="Add new Categery">
          </div>
        </div>
        <div class="form-group">
