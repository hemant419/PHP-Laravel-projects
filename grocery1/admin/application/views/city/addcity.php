...
<div class="col-md-12">
  <section class="boxs">
    ...
    <div class="boxs-body">
      <form class="form-horizontal" role="form" method="post" action="<?PHP echo site_url() ?>/cityControl/insertdata">
		...
		<div class="form-group">
          ...
          <div class="col-sm-3">
            <input type="text" name="city" value="" class="form-control" id="inputEmail3" placeholder="Add new Categery">
          </div>
        </div>
        <div class="form-group">
