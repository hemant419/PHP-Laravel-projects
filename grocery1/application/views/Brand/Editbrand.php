...
<div class="row" style="margin-left:250px; margin-top:150px;">
					<div class="col-md-12">
                 	...
                 	<div class="boxs-body">
                                ...
                                action="<?php echo site_url() ?>/Brandc/update/<?php echo $data->brand_id;?>"  enctype="multipart/form-data">
...
<img src="<?php echo base_url() ?>/Brand/<?php echo $data->brand_image ?>" height="100" width="100" />
                                    	</div>
									</div>
                                    <div class="form-group">
										<label class="col-sm-3 control-label">brand name</label>
										<div class="col-sm-9">
											<input type="text"  value="<?php echo $data->brand_name;?>" name="brand_name" class="form-control" data-parsley-trigger="change" required>			
										</div>
									</div>
