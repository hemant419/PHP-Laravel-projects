...
<div class="row" style="margin-left:250px; margin-top:150px;">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" method="post" action="<?php echo site_url();?>/SubCategoryc/update/<?php echo $data->subcategory_id;?>" name="form4" role="form" id="form4" data-parsley-validate>
		...
		<?php
					...
					?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="sname" class="form-control" value="<?php echo $data->subcategory_name;?>" data-parsley-trigger="change" required>
										</div>
									</div>
