...
<div class="row" style="margin-left:250px; margin-top:150px;">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" method="post" action="<?php echo site_url();?>/Cityc/update/<?php echo $data->city_id;?>" name="form4" role="form" id="form4" data-parsley-validate>
		...
		<?php
					...
					?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="cat" class="form-control" data-parsley-trigger="change" required value="<?php echo $data->city_name;?>">
                               		</div>
									</div>
