                                ...
                                <div class="body table-responsive members_profiles">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url();?>assets/images/xs/avatar1.jpg" alt="user" width="40"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url();?>assets/images/xs/avatar2.jpg" alt="user" width="40"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url();?>assets/images/xs/avatar3.jpg" alt="user" width="40"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url();?>assets/images/xs/avatar4.jpg" alt="user" width="40"> </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url();?>assets/images/xs/avatar5.jpg" alt="user" width="40"> </td>
                                                <td>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <section class="boxs user_widget">
                            ...
                            <div class="uw_image"> <img class="img-circle" src="<?php echo base_url();?>assets/images/profile-photo.jpg" alt="User Avatar"></div>
                            <div class="uw_footer">
                ...
                <div class="row clearfix">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="boxs project_widget">
                             <div class="pw_img">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/images/project_img1.jpg" alt="About the image">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="boxs project_widget">
                            <div class="pw_img">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/images/project_img2.jpg" alt="About the image">
                            </div>                            
                            <div class="pw_content">
                                <div class="pw_header">
                                    <h6>New Dashboard</h6>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="boxs project_widget">
                             <div class="pw_img">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/images/project_img3.jpg" alt="About the image">
                            </div>
                            <div class="pw_content">
                                <div class="pw_header">
                                    <h6>Mobile App</h6>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="boxs project_widget">
                             <div class="pw_img">
                                <img class="img-responsive" src="<?php echo base_url();?>assets/images/project_img4.jpg" alt="About the image">
                            </div>
                            <div class="pw_content">
                                <div class="pw_header">
                                    <h6>New Dashboard</h6>
                                ...
                                <ul class="inbox-widget list-unstyled clearfix">
                                    <li class="inbox-inner"> <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-img"> <img src="<?php echo base_url();?>assets/images/xs/avatar1.jpg" alt=""> </div>
                                    ...
                                    <li class="inbox-inner"> <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-img"> <img src="<?php echo base_url();?>assets/images/xs/avatar2.jpg" alt=""> </div>
                                            <div class="inbox-item-info">
                                    ...
                                    <li class="inbox-inner"> <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-img"> <img src="<?php echo base_url();?>assets/images/xs/avatar3.jpg" alt=""> </div>
                                            <div class="inbox-item-info">
                                    ...
                                    <li class="inbox-inner"> <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-img"> <img src="<?php echo base_url();?>assets/images/xs/avatar5.jpg" alt=""> </div>
                                            <div class="inbox-item-info">
