...
<section class="featured-post-area no-padding">
			...
			<div class="row">
				<div class="col-lg-7 col-md-12 pad-r">
					<div id="featured-slider" class="owl-carousel owl-theme featured-slider">
						<div class="item" style="background-image:url({{url('client/images/news/lifestyle/health5.jpg')}})">
						...
						<div class="item" style="background-image:url({{url('client/images/news/tech/gadget2.jpg')}})">
							<div class="featured-post">
						 		<div class="post-content">
						...
						<div class="item" style="background-image:url({{url('client/images/news/lifestyle/travel5.jpg')}})">
							<div class="featured-post">
						 		<div class="post-content">
						...
						<div class="col-md-12">
							<div class="post-overaly-style contentTop hot-post-top clearfix">
								<div class="post-thumb">
									<a href="#"><img class="img-fluid" src="{{url('client/images/news/tech/gadget4.jpg')}}" alt="" /></a>
								</div>
								<div class="post-content">
						 			<a class="post-cat" href="#">Gadget</a>
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="{{url('client/images/news/lifestyle/health5.jpg')}}" alt="" /></a>
											</div>
											<a class="post-cat" href="#">Health</a>
											<div class="post-content">
									 			<h2 class="post-title title-medium">
							...
							<div class="item">
								...
								<ul class="list-post">
									...
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#"><img class="img-fluid" src="{{url('client/images/news/lifestyle/architecture3.jpg')}}" alt="" /></a>
											</div>
								...
								<ul class="list-post">
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/lifestyle/food3.jpg')}}" alt="" />
												</a>
											</div>
									...
									<li class="clearfix">
										<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/tech/game1.jpg')}}" alt="" />
												</a>
											</div>
					      	...
					      	<div class="row">
						      	<div class="col-lg-6 col-md-6">
						      		<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/tech/gadget1.jpg')}}" alt="" />
												</a>
											</div>
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/gadget2.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/gadget3.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/gadget4.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/gadget5.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/game2.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/game3.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/game4.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/game5.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
								...
								<div class="row">
						      	<div class="col-lg-6 col-md-6">
						      		<div class="post-block-style clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/tech/robot1.jpg')}}" alt="" />
												</a>
											</div>
											...
											<ul class="list-post">
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/robot2.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/robot3.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/robot4.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
												...
												<li class="clearfix">
													<div class="post-block-style post-float clearfix">
														<div class="post-thumb">
															<a href="#">
																<img class="img-fluid" src="{{url('client/images/news/tech/robot5.jpg')}}" alt="" />
															</a>
														</div><!-- Post thumb end -->
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="post-overaly-style clearfix">
									<div class="post-thumb">
										<a href="#">
											<img class="img-fluid" src="{{url('client/images/news/lifestyle/travel1.jpg')}}" alt="" />
										</a>
									</div>
									...
									<ul class="list-post">
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/food1.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Food</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/health1.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Health</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/travel2.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Travel</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/architecture2.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Architecture</a>
												</div><!-- Post thumb end -->
							...
							<div class="col-lg-6 col-md-6">
								<div class="post-overaly-style last clearfix">
									<div class="post-thumb">
										<a href="#">
											<img class="img-fluid" src="{{url('client/images/news/lifestyle/architecture3.jpg')}}" alt="" />
										</a>
									</div>
									...
									<ul class="list-post">
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/food2.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Food</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/architecture1.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Architecture</a>
												</div><!-- Post thumb end -->
										...
										<li class="clearfix">
											<div class="post-block-style post-float clearfix">
												<div class="post-thumb">
													<a href="#">
														<img class="img-fluid" src="{{url('client/images/news/lifestyle/travel5.jpg')}}" alt="" />
													</a>
													<a class="post-cat" href="#">Travel</a>
												</div><!-- Post thumb end -->
				...
				<div class="col-lg-4 col-md-12">
					<div class="sidebar sidebar-right">
						...
						<div class="widget text-center">
							<img class="banner img-fluid" src="{{url('client/images/banner-ads/ad-sidebar.png')}}"" alt="" />
						</div><!-- Sidebar Ad end -->
							...
							<div id="post-slide" class="owl-carousel owl-theme post-slide">
								...
								<div class="item">
									...
									<div class="post-overaly-style text-center clearfix">
									   <div class="post-thumb">
									      <a href="#">
									         <img class="img-fluid" src="{{url('client/images/news/lifestyle/health5.jpg')}}" alt="" />
									      </a>
									   </div><!-- Post thumb end -->
	...
	<section class="ad-content-area text-center no-padding">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<img class="img-fluid" src="{{url('client/images/banner-ads/ad-content-one.jpg')}}" alt="" />
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
							...
							<ul class="list-post">
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-fluid" src="{{url('client/images/news/lifestyle/travel3.jpg')}}" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<li class="clearfix">
									<div class="post-block-style post-float clearfix">
										<div class="post-thumb">
											<a href="#">
												<img class="img-fluid" src="{{url('client/images/news/lifestyle/travel4.jpg')}}" alt="" />
											</a>
										</div><!-- Post thumb end -->
								...
								<ul class="list-post review-post-list">
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/review/review1.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/review/review2.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/review/review3.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
									...
									<li class="clearfix">
										<div class="post-block-style post-float clearfix">
											<div class="post-thumb">
												<a href="#">
													<img class="img-fluid" src="{{url('client/images/news/review/review4.jpg')}}" alt="" />
												</a>
											</div><!-- Post thumb end -->
	...
	<section class="ad-content-area text-center">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<img class="img-fluid" src="{{url('client/images/banner-ads/ad-content-two.png')}}"" alt="" />
				</div><!-- Col end -->
			</div><!-- Row end -->
		</div><!-- Container end -->
